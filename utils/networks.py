...
class Value(nn.Module):
    ...
    def setup(self):
        ...
        value_net = mlp_class((*self.hidden_dims, self.num_atoms), activate_final=False, layer_norm=self.layer_norm)
    ...
    def __call__(self, observations, actions=None):
        ...
        if self.num_atoms ==1 : return v.squeeze(-1)
        else: return nn.softmax(v, axis=-1) 
